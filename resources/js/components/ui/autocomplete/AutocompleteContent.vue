  ...
  <AutocompletePortal>
    <AutocompleteContent
      ...
      :class="cn(
        ...
        position === 'popper'
          && 'w-(--reka-autocomplete-trigger-width) min-w-(--reka-autocomplete-trigger-width) data-[side=bottom]:translate-y-1 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1',
